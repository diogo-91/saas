...
export function Sidebar() {
  ...
  return (
    <aside
      className={cn(
        'flex flex-col bg-slate-900 text-slate-50 border-r border-slate-800 transition-all duration-300 shrink-0',
        collapsed ? 'w-14' : 'w-56'
      )}
    >
      {/* Logo */}
      <div className="flex items-center gap-2 px-3 py-4 border-b border-slate-800 h-[60px]">
