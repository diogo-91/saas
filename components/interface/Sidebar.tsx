...
export function Sidebar() {
  ...
  return (
    ...
    >
      {/* Logo */}
      <div className="flex items-center gap-2 px-3 py-4 border-b h-[60px]">
      ...
      <div className="border-t p-2 space-y-1">
        <Link
          href="/settings"
          className={cn(
            'flex items-center gap-3 px-2 py-2 rounded-lg text-sm font-medium text-muted-foreground hover:bg-muted hover:text-foreground transition-colors',
        ...
        <Button
          variant="ghost"
          size="icon"
          className={cn('h-8 w-full text-muted-foreground', collapsed ? 'w-10' : 'w-full')}
